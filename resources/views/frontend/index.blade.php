            ...
            <div class="row">
                <div class="col-md-4 mb-4 mb-md-0">
                    <a class="category-item" href="{{ route('shop.index', $categories[0]->slug ?? '') }}">
                        ...
                        @endif
                        <strong class="category-item-title">{{ $categories[0]->name ?? 'Clothing' }}</strong>
                    </a>
                </div>
                <div class="col-md-4 mb-4 mb-md-0">
                    <a class="category-item mb-4" href="{{ route('shop.index', $categories[1]->slug ?? '') }}">
                        ...
                        @else
                            <img class="img-fluid"
                                 ...
                                 alt="{{ $categories[1]->name ?? '' }}">
                        @endif
                        <strong class="category-item-title" style="margin-top: -124px;">{{ $categories[1]->name ?? 'Shoes' }}</strong>
                    </a>
                    <a class="category-item" href="{{ route('shop.index', $categories[2]->slug ?? '') }}">
                        ...
                        @else
                            <img class="img-fluid"
                                 ...
                                 alt="{{ $categories[2]->name ?? '' }}">
                        @endif
                        <strong class="category-item-title" style="margin-top: 104px;">{{ $categories[2]->name ?? 'Wearables' }}</strong>
                    </a>
                </div>
                <div class="col-md-4">
                    <a class="category-item" href="{{ route('shop.index', $categories[3]->slug ?? '') }}">
                        ...
                        @endif
                        <strong class="category-item-title">{{ $categories[3]->name ?? 'Entertainment' }}</strong>
                    </a>
                </div>
            </div>
        </section>
                    ...
                    <div class="fruits-choose-wrapper">
                        <div class="single-fruits-choose">
                            ...
                            <div class="fruits-choose-content">
                                <h4>Free Shipping.</h4>
                                <p> Shop online with Free shipping now! </p>
                            </div>
                        </div>
                        <div class="single-fruits-choose">
                            <div class="fruits-choose-serial">
                            ...
                            <div class="fruits-choose-content">
                                ...
                                <p> Buy 100 % Original products at low prices in Asia Pacific Region. </p>
                            </div>
                        </div>
                        <div class="single-fruits-choose">
                            <div class="fruits-choose-serial">
                            ...
                            <div class="fruits-choose-content">
                                ...
                                <p> Delivering customer service digitally through multiple channels. </p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="fruits-services-wrapper">
        <div class="single-fruits-services">
            ...
            <div class="fruits-services-content">
                <h4>Free Shipping</h4>
                <p>Cost Free Shipping From Asia Pasific Regions</p>
            </div>
        </div>
        <div class="single-fruits-services">
            <div class="fruits-services-img">
            ...
            <div class="fruits-services-content">
                ...
                <p>The Lifetime MoneyBack Guarantee.</p>
            </div>
        </div>
        <div class="single-fruits-services">
            <div class="fruits-services-img">
